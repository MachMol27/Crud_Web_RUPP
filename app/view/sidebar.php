<aside class="w-64 h-screen bg-gray-800 text-white p-5 fixed top-0 left-0">
    ...
    <ul class="space-y-3">
        <li><a href="/" class="block hover:text-blue-400">Home Page</a></li>
        <li><a href="/add" class="block hover:text-blue-400">Add Information</a></li>
        
        <li><a href="/about" class="block hover:text-blue-400">About Me</a></li>
    </ul>
</aside>
